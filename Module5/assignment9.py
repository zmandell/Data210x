...
#
# .. your code here ..
X = pd.read_csv('/Users/zach.mandell/Downloads/College.csv', index_col=0)
...
X_train, X_test, y_train, y_test = train_test_split(ind, dep, test_size=0.3, random_state=7)

...
#
# .. your code here ..
mat = scipy.io.loadmat('/Users/zach.mandell/Downloads/DAT210x-master/Module4/Datasets/face_data.mat')
...
#
# .. your code here ..
labels = pd.read_csv('/Users/zach.mandell/Downloads/DAT210x-master/Module5/Datasets/face_labels.csv', header=None).iloc[:,0]
...
#
# .. your code here ..
data_train, data_test, label_train, label_test = train_test_split(X, labels, test_size=0.15, random_state=7)

...
#
df = pd.read_csv('/Users/zach.mandell/Downloads/DAT210x-master/Module5/Datasets/life_expectancy.csv',sep='\t' )
...
#
# .. your code here ..
X_train = df[df['Year'] < 1986][['Year']]
y_train = df.iloc[X_train.index]['WhiteMale']

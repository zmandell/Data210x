...
#
X = pd.read_csv('/Users/zach.mandell/Downloads/DAT210x-master/Module5/Datasets/wheat.data')
...
knn.fit(pca_train, label_train)



# HINT: Ensure your KNeighbors classifier object from earlier is called 'knn'
plotDecisionBoundary(knn, pca_train, label_train)
...
#
# .. your code here ..
accuracy_score = knn.score(pca_test, label_test)

...
X = pd.read_csv('/Users/zach.mandell/Downloads/DAT210x-master/Module5/Datasets/breast-cancer-wisconsin.data', header=None)
...
#
# .. your code here ..
data_train, data_test, label_train, label_test = train_test_split(X, labels, test_size=0.5, random_state=7)
...
X_train_norm = norm.transform(data_train)

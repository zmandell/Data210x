...
mat = scipy.io.loadmat('/Users/zmandell/Downloads/DAT210x-master/Module4/Datasets/face_data.mat')
...
#
Plot2D(T, title='PCA', x=1, y=2, num_to_plot=40)
...
Plot2D(manifold, title='Isomap', x=1, y=2, num_to_plot=40)

...
X_train, X_test, y_train, y_test = load('/Users/zach.mandell/Downloads/DAT210x-master/Module6/Datasets/optdigits.tes', '/Users/zach.mandell/Downloads/DAT210x-master/Module6/Datasets/optdigits.tra')
...
model = SVC(kernel='rbf',C=1, gamma=.001)
